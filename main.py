...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataX', type=str, default="./../data/landscapes/")
    parser.add_argument('--dataY', type=str, default="./../data/art/")
    ...
    parser.add_argument('--loadModels', type=str2bool, default=True)
